...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      expect(getByTestId("jaredpalmer.formik-full-name")).toHaveTextContent(
        "jaredpalmer/formik",
      )
      expect(getByTestId("jaredpalmer.formik-description")).toHaveTextContent(
        "Build forms in React, without the tears",
      )
      expect(getByTestId("jaredpalmer.formik-language")).toHaveTextContent(
        "TypeScript",
      )
